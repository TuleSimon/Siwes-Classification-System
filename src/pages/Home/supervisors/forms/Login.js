...
function Login() {
    ...
    const submitForm = (e) => {
        ...
        axios.post('http://localhost:5000/supervisors/signin', {"employeeno":employeeno, "password":password})
        .then((res) => {
            console.log(res)
            if(res.data[0]==null){
                ...
                axios.post('http://localhost:5000/supervisors/students', {"id":res.data[0]._id}).then(
